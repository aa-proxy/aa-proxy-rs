...
pub const COMPANION_OP_AUTH_STATUS: u8 = 0x0A;
pub const COMPANION_OP_AUTH_RESPONSE: u8 = 0x0B;
pub const COMPANION_OP_AUTH_SET_TOKEN: u8 = 0x0C;
...
pub const COMPANION_OP_AUTH_STATUS_REPLY: u8 = 0x8A;
pub const COMPANION_OP_AUTH_OK: u8 = 0x8B;
