...
impl AppConfig {
    ...
    pub fn save(&self, config_file: PathBuf) {
        ...
        doc["bt_real_hu_passthrough_enabled"] =
            value(self.bt_real_hu_passthrough_enabled);
        doc["bt_real_hu_passthrough_address"] =
            value(self.bt_real_hu_passthrough_address.clone());
